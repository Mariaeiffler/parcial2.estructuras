...
def crear_habitaciones_suite():
    h101 = Habitacion_Suite(101,2,1,35000,10000,4,True,True)
    h102 = Habitacion_Suite(102,2,1,35000,10000,4,True,True)
    h103 = Habitacion_Suite(103,2,1,35000,10000,4,True,True)
    h104 = Habitacion_Suite(104,2,1,35000,10000,4,True,True)
