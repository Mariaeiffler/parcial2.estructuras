...
def validacion_preg_hab():
    ...
    match pregunta:
        case 1:
            pregunta1 = input('Elija una de las siguientes opciones: \n h1: Sin baño privado y sin balcón ($5000) \n h2: Con baño y sin balcón ($10000) \n h3: Con baño privado y sin balcón ($10000) \n h4: Con baño privado y con balcón')
            validacion = validacion_h(pregunta1)
            while(validacion == False):
                pregunta1 = input('Elija una de las siguientes opciones: \n h1: Sin baño privado y sin balcón ($5000) \n h2: Con baño y sin balcón ($10000) \n h3: Con baño privado y sin balcón ($10000) \n h4: Con baño privado y con balcón')
                validacion = validacion_h(pregunta1)
            return pregunta1
        case 2:
            pregunta1 = input('Elija una de las siguientes opciones: \n h5: Sin baño privado y sin balcón ($5000) \n h6: Con baño y sin balcón ($10000) \n h7: Con baño privado y sin balcón ($10000) \n h8: Con baño privado y con balcón')
            validacion = validacion_h(pregunta1)
            while(validacion == False):
                pregunta1 = input('Elija una de las siguientes opciones: \n h5: Sin baño privado y sin balcón ($5000) \n h6: Con baño y sin balcón ($10000) \n h7: Con baño privado y sin balcón ($10000) \n h8: Con baño privado y con balcón')
                validacion = validacion_h(pregunta1)
            return pregunta1
        case 3:
            pregunta1 = input('Elija una de las siguientes opciones: \n h9: Sin baño privado y sin balcón ($5000) \n h10: Con baño y sin balcón ($10000) \n h11: Con baño privado y sin balcón ($10000) \n h12: Con baño privado y con balcón')
            validacion = validacion_h(pregunta1)
            while(validacion == False):
                pregunta1 = input('Elija una de las siguientes opciones: \n h9: Sin baño privado y sin balcón ($5000) \n h10: Con baño y sin balcón ($10000) \n h11: Con baño privado y sin balcón ($10000) \n h12: Con baño privado y con balcón')
                validacion = validacion_h(pregunta1)
